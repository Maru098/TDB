    ...
    <ul class="nav">
      ...
      <li class="nav-item {{ request()->routeIs('rateYo.index') ? 'active' : '' }}">
        <a class="nav-link" data-bs-toggle="collapse" href="#ui-rate" aria-expanded="false" aria-controls="ui-rate">
          <span class="menu-title">Bình luận đánh giá</span>
          <i class="menu-arrow"></i>
        ...
        <div class="collapse" id="ui-rate">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link {{ request()->routeIs('rateYo.index') ? 'active' : '' }}" href="{{ route('rateYo.index') }}">Duyệt bình luận</a>
            </li>
      ...
      <li class="nav-item {{ request()->routeIs('order.index') ? 'active' : '' }}">
        ...
        <div class="collapse" id="ui-cart">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link {{ request()->routeIs('order.index') ? 'active' : '' }}" href="{{ route('order.index') }}">Danh mục giỏ hàng</a>
            </li>
