                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div id="imagePreviewWrapper" style="margin-top: 10px;">
                                                                <img id="imagePreview" src="{{ $value->images ? $value->images : 'https://png.pngtree.com/png-vector/20240202/ourlarge/pngtree-bussinesman-cartoon-avatar-png-image_11591522.png' }}"
